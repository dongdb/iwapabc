...
<body class="iwapui center_body">
	<div id="divDialog" class="divDialog">
		...
		<div class="dialog" id="detailModal"
			...
			<div class="table_nav2">
				<a href="javaScript:void(0)" id="doCheck" onclick="doCheck()"> <img
					alt="" src="../iwapabc/images/icon/check.png" /> 入库验收
	...
	<form id="Conditions" class="col-md-12 clearfix">
	...
	<div class="col-md-12">
		<table id="iwapGrid1"
			...
			<tr>
				<th data-grid-name="ROW_NUM" class="tl">序号</th>
				<th data-grid-name="DISPOSALNO" class="tl">处置单号</th>
				<th data-grid-name="DISPOSALTITLE" class="tl">处置标题</th>
				<th data-grid-name="DISPOSALDATETIME" class="tl">处置时间</th>
				<th data-grid-name="DISPOSALMODELABEL" class="tl">处置方式</th>
				<th data-grid-name="CREATEPSNNAME" class="tl">申请人</th>
				<th data-grid-name="SACTIVITYNAMES" class="tl">当前环节</th>
				<th data-grid-name="SEXECUTORNAMES" class="tl">当前人员</th>
				<th data-grid-name="SSTATUSNAME" class="tl">当前状态</th>
				<th data-grid-name="DISPOSALNO" option="option" option-html=''><span>详细信息</span>
					<s><a href="javaScript:void(0)" id="detail" 
						onclick="detail(this)"><img alt=""
