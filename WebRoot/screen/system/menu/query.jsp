...
<script type="text/javascript">
	...
	function doEdit(module_id) {
		window.location = "${ctx}/iwap.ctrl?txcode=menuMg&option=show&moduleId="
				+ module_id;
	}
...
<body class="iwapui center_body">
	...
	<div class="col-md-8">
		<div class="search_btn">
			<a href="javaScript:void(0)" class="btn btn-primary mr30"
				id="btn_query">查询</a> <a href="javaScript:void(0)"
				class="btn btn-primary mr30" id="btn_clear">清空</a> <a
				href="${ctx}/iwap.ctrl?txcode=menuMg&option=add"
