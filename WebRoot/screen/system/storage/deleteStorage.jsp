	...
	<div id="divDialog" class="divDialog">
		...
		<div class="dialog" id="stoModal" style="width: 900px; height: 518px;">
			...
			<div class="col-md-12">
				<div class="table_nav2">
					<a class="disa" href="javaScript:void(0)" id="saveSto"
						onclick="saveSto()"> <img alt=""
						src="../iwapabc/images/icon/save.png" /> 保存
					</a>
				</div>
			</div>
			<div class="col-md-12"
			...
			<div class="col-md-12">
				<form method="post" onsubmit="return false" id="inForm">
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
							责任部门<input name="resdept" type="text" data-iwap-xtype="TextField"
								id="resdept" class="input_text_1">
						</div>
					</div>
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
							责&nbsp;任&nbsp;人&nbsp;<input name="respsn" type="text"
								data-iwap-xtype="TextField" id="respsn" class="input_text_1">
						</div>
					</div>
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
							签报编号<input name="sign" type="text" data-iwap-xtype="TextField"
								id="sign" class="input_text_1">
						</div>
					</div>
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
					...
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
							入库日期<input name="intime" type="date" data-iwap-xtype="TextField"
								id="intime" class="input_text_1" value="">
						</div>
					</div>
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
							入库金额<input name="amount" type="text" data-iwap-xtype="TextField"
								id="amount" class="input_text_1">
						</div>
					</div>
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
							放置位置<input name="place" type="text" data-iwap-xtype="TextField"
								id="place" class="input_text_1">
						</div>
					</div>
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
					...
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
							动支单号<input name="budgetno" type="text"
								data-iwap-xtype="TextField" id="budgetno" class="input_text_1">
						</div>
					</div>
					<div class="col-md-3">
						<div class="inputbox" style="margin: 2px;">
							是否关联动支单 <input type="radio" name="radiobutton" id="yes"
								value="yes" checked onchange="setDZD()" /> 是 <input
								type="radio" name="radiobutton" id="no" value="no"
								onchange="setDZD()" /> 否
						</div>
					</div>
				</form>
				<div class="col-md-12">
					发票信息
					<div
						style="margin-left: 55px; height: 110px; width: 780px; border: 1px solid #CCCCCC;">
						<table id="billGrid"
							...
							<tr>
								<div class="table_nav2"
									...
									<a href="javaScript:void(0)" id="add" onclick=""> <img
										alt="" src="../iwapabc/images/icon/add.png" /> 添加
									</a> <a href="javaScript:void(0)" id="del" onclick=""> <img
										alt="" src="../iwapabc/images/icon/delete.png" /> 删除
									</a> <a href="javaScript:void(0)" id="fresh" onclick=""> <img
				...
				<div class="col-md-12">
					<div class="inputbox" style="margin: 2px;">
						入库附件<a href="#"><input name="remarkfile" type="text"
							data-iwap-xtype="TextField" id="remarkfile" class="input_text_1 "
			...
			<div class="col-md-12">
				<div class="col-md-12">
					<div class="table_nav2"
						style="border: 1px solid white; padding: 0px;">
						<a href="javaScript:void(0)" id="add" onclick=""> <img alt=""
							src="../iwapabc/images/icon/add.png" /> 添加
						</a> <a href="javaScript:void(0)" id="del" onclick=""> <img alt=""
		...
		<div class="col-md-4">
			<div class="table_nav2">
				...
				</a> <a href="javaScript:void(0)" id="stoDetail" onclick="stoDetail()">
					<img alt="" src="../iwapabc/images/icon/checkDetail.png" />
					查看/修改入库单
				</a>
			</div>
		</div>
			...
			<div class="col-md-8">
				<div class="inputbox">
					搜索<input name="fuzzySearch" type="text" data-iwap-xtype="TextField"
						id="fuzzySearch" class="input_text_1" value="" style="margin-top:5px;"
						onkeypress="if(event.keyCode==13) {iwapGrid1.doQuery();return false;}">
				</div>
				<div class="inputbox ">
					入库时间 <select data-iwap-xtype="ListField" name="createtime" style="margin-top:5px;"
						onchange="gradeChange()" id="createtime" class="select_content">
						<option value="0">--全部--</option>
					</select>
				</div>
				<div class="inputbox ">
					<input name="pid1" type="date" data-iwap-xtype="TextField" style="margin-top:5px;"
	...
	<div class="col-md-12">
		<table id="iwapGrid1"
			...
			<tr>
				...
				<th data-grid-name="FASSETCONFIRM" class="tl">确认状态</th>
...
<script type="text/javascript">
	...
	function doDelete() {
		...
		var param = {
			'option' : "remove",
			'txcode' : "deleteStorage",
			'fid' : iwapGrid1.getCurrentRow()['FID'],
			'actionId' : "doBiz"
		};
	...
	function stoDetail() {
		...
		sendAjax(form, 'deleteStorage', 'doBiz', callFn);
