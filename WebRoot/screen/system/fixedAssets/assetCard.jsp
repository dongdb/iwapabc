...
$(document).ready(function() {
			...
			/*查询表格初始化  设置默认查询条件*/
			var fData={'actionId':'doBiz','start':'0','limit':'10','txcode':'assetCard'};
...
function exportData(){
	var data = {'exportFlag':'1','filetype':'xls',
			//'actionType':'expdata',
			'txcode':'assetCard','actionId':'doBiz','start':'0','limit':'30000'};
...
//编辑
function detail(obj){
	window.location="${ctx}/iwap.ctrl?txcode=assetDetail&deptid="+iwapGrid.getCurrentRow().FCODE; 
};
