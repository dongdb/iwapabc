...
<body class="iwapui center_body">
	...
	<div class="table_nav2 col-md-12">
		<a href="javaScript:void(0)" id="storage" onclick="doStorage()">入库记录</a>
	...
	<form method="post" onsubmit="return false" id="dialogarea">
		...
		<div class="col-md-10">
			<div class="col-md-8">
				...
				<div class="col-md-6">
					<div class="inputbox1 pr">
						<span>规格型号</span> <input name="FSPECTYPE" type="text"
							data-iwap-xtype="TextField" id="FSPECTYPE" class="input_text_1"disabled="disabled"
							disabled="disabled">
					</div>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="inputbox1 pr">
						<span>资产原值</span>&nbsp;<input name="FORIGINVALUE" type="text"
							...
							id="FCURRENCY" class="input_text_1" disabled="disabled"
							style="width: 50px;">
					</div>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="inputbox1 pr">
						<span>保修期</span> <input name="FWARRANTYMONTH" type="text"
							data-iwap-xtype="TextField" id="FWARRANTYMONTH" disabled="disabled"
				...
				<div class="col-md-6">
					<div class="inputbox1 pr">
						<span>保修期至</span> <input name="FWARRANTYDATE" type="text"
							data-iwap-xtype="TextField" id="FWARRANTYDATE" disabled="disabled"
							class="input_text_1">
					</div>
				</div>
				<div class="col-md-6">
					<div class="inputbox1 pr">
						<span>管理单位</span> <input name="ADMINDEPT" type="text" disabled="disabled"
				...
				<div class="col-md-6">
					<div class="inputbox1 pr">
						<span>放置位置</span> <input name="FEXTENDSTR2" type="text" disabled="disabled"
				...
				<div class="col-md-12">
					<div class="inputbox1 pr" style="padding-top: 10px;">
						<span>详细配置</span> <input name="FDETAILINFO" type="text"
							...
							style="width: 470px; height: 80px;" disabled="disabled">
					</div>
				</div>
				<div class="col-md-12">
					<div class="inputbox1 pr" style="padding-top: 10px;">
						<span>备注</span> <input name="FREMARK" type="text"
							...
							style="width: 470px; height: 50px;" disabled="disabled">
					</div>
				</div>
			</div>
			<div class="col-md-4">
				...
				<div class="inputbox pr" style="padding-top: 10px;">
					<span>制造商</span> <input name="FFACTORY" type="text" disabled="disabled"
...
<script>
	...
	function doReturn() {
		window.location = "${ctx}/iwap.ctrl?txcode=assetAccount";
	}
