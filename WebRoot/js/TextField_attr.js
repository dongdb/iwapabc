...
$(function() {
	...
	setTimeout(function(){
		...
		$('body').find('div[data-iwap ="tooltipdiv"]').each(function(index, val) {
		    ...
		    var _html = '<i class="err_status" id="err_iwap-gen-1">*</i><div class="sm_tooltip_r" id=""></div><div class="tooltip right" id=""></div><div class="tooltip_arrow_r" id="">'+tooltext+'</div>';
		    //输入框字数限制遍历
